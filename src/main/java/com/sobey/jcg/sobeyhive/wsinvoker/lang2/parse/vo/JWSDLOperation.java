...
public class JWSDLOperation
{
    ...
    public void setBindingType(ABindingType bindingType) {
        this.bindingType = bindingType;
    }

    public ABindingType getBindingType() {
        return bindingType;
    }
	...
	public JWSDLOperation clone() throws CloneNotSupportedException {
        ...
        obj.setBindingType(this.getBindingType());
		obj.setAvilable(this.isAvilable());
		return obj;
	}
}
