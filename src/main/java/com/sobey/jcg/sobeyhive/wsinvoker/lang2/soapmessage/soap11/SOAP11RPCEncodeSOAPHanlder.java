...
import com.sobey.jcg.sobeyhive.wsinvoker.lang2.soapmessage.AnyTypeObject;
 ...
 * @author wx
 */
public class SOAP11RPCEncodeSOAPHanlder extends ASOAPHandler
{
	 ...
	 * 处理RPC的返回
	 */
	private static ThreadLocal<SOAPBody> local = new ThreadLocal<SOAPBody>();
