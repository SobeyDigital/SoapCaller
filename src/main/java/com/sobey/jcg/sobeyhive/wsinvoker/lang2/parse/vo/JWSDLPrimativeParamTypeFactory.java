package com.sobey.jcg.sobeyhive.wsinvoker.lang2.parse.vo;
 ...
 * @author wx
 */
public class JWSDLPrimativeParamTypeFactory 
{
	private static Map cache = new HashMap();
	
	/*2013年04月21日20:12:34 sunxiang  修改了这个地方.
	...
	{
		synchronized(JWSDLPrimativeParamTypeFactory.class){
			if(cache.size()<1){
				QName typeName = null;
		...
		return (JWSDLParamType)cache.get(key);
	}
